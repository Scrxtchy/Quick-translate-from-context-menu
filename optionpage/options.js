...
document.getElementById('labelOpenByNewPopup_A').textContent = browser.i18n.getMessage('optionpageOpenByNewPopup');
...
document.getElementById('labelOpenByNewPopup_B').textContent = browser.i18n.getMessage('optionpageOpenByNewPopup');
